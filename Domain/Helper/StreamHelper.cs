...
namespace Domain.Helper
{
    public class StreamHelper
    {
        ...
        public static byte[] Image2ByteWithPath(string imagePath)
        {
            ...
            {
                Logger.Error(ex, "StreamHelper.Image2ByteWithPath 异常");
                return null;
            }
        }
        ...
        public static Image BytToImg(byte[] byt)
        {
            ...
            {
                Logger.Error(ex, "StreamHelper.BytToImg 异常");
                return null;
            }
        }
        ...
        public static Image Url2Img(string imageUrl)
        {
            ...
            {
                Logger.Error(ex, "StreamHelper.Url2Img 异常,imageUrl:{0}", imageUrl);
            }
        ...
        public static Image ImagePath2Img(string imagePath)
        {
            ...
            {
                Logger.Error(ex, "StreamHelper.ImagePath2Img 异常,imagePath:{0}", imagePath);
                return null;
            }
        }
    }
